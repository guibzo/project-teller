    ...
    return (
      <div className={cn('relative', containerClassName)}>
        <input
          type={inputType}
          className={cn(
            'peer flex h-10 w-full rounded-md border border-input bg-background px-2.5 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-app-content-placeholder focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
            startIcon && 'ps-9',
